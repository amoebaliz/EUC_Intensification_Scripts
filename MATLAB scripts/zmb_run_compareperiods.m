...
% q1 = 1:432; q2 = 433:864; q3 = 853:1284 ; q4 = 1285:1716;

% specify/form climped seasonal mean
...
[~,latx,depth5,u5,dudt5,ududx5,vdudy5,wdudz5,zpgf5,corf5,frich5,fricv5] = zmb_isopycnal(lon,lat,depth,u_mean,v_mean,w_mean,temp_mean,salt_mean,ssh_mean);
% [~,latx,depth1,u1,dudt1,ududx1,vdudy1,wdudz1,zpgf1,corf1,frich1,fricv1] = zmb_isopycnal(lon,lat,depth,u1,v1,w1,temp1,salt1,ssh1);
% [~,latx,depth4,u4,dudt4,ududx4,vdudy4,wdudz4,zpgf4,corf4,frich4,fricv4] = zmb_isopycnal(lon,lat,depth,u4,v4,w4,temp4,salt4,ssh4);
% 
...
%  
%%
 save mean_fields lon latx depth5 u5 ssh_mean taux_mean... 
     dudt5 ududx5 vdudy5 wdudz5 zpgf5 corf5 frich5 fricv5

% save MAM_quarter1 lon latx depth1 u1 ssh1 taux1... 
%     dudt1 ududx1 vdudy1 wdudz1 zpgf1 corf1 frich1 fricv1
% 
% save MAM_quarter4 lon latx depth4 u4 ssh4 taux4... 
...
% save JJA_quarter1 lon latx depth1 u1 ssh1 taux1... 
%     dudt1 ududx1 vdudy1 wdudz1 zpgf1 corf1 frich1 fricv1
% 
% save JJA_quarter4 lon latx depth4 u4 ssh4 taux4... 
%     dudt4 ududx4 vdudy4 wdudz4 zpgf4 corf4 frich4 fricv4
%
