...
%                            [~,latx,depth1,temp1, u1,dudt1,ududx1,vdudy1,wdudz1,zpgf1,corf1,frich1,fricv1] = zmb_isopycnal(lon,lat,depth,u1,v1,w1,temp1,salt1,ssh1);                
%                            save May_quarter1 lon latx depth1 temp1 u1 ssh1 taux1... 
...
%                             save May_quarter4 lon latx depth4 temp4 u4 ssh4 taux4... 
%                                 dudt4 ududx4 vdudy4 wdudz4 zpgf4 corf4 frich4 fricv4
            ...
            if get_mean == 1
                         [~,latx,depth5,temp5,u5,dudt5,ududx5,vdudy5,wdudz5,zpgf5,corf5,frich5,fricv5] = zmb_isopycnal(lon,lat,depth,u_mean,v_mean,w_mean,temp_mean,salt_mean,ssh_mean);
                            ...
                            save mean_fields_E lon latx depth5 u5 ssh_mean taux_mean... 
...
%                         if get_mean == 2
% 
%                             save MAM_quarter1 lon latx depth1 temp1 u1 ssh1 taux1... 
%                                 dudt1 ududx1 vdudy1 wdudz1 zpgf1 corf1 frich1 fricv1
% 
%                             save MAM_quarter4 lon latx depth4 temp4 u4 ssh4 taux4... 
%                                 dudt4 ududx4 vdudy4 wdudz4 zpgf4 corf4 frich4 fricv4
%                             % 
...
%                         elseif get_mean == 3
% 
%                             save JJA_quarter1 lon latx depth1 temp1 u1 ssh1 taux1... 
%                                 dudt1 ududx1 vdudy1 wdudz1 zpgf1 corf1 frich1 fricv1
% 
%                             save JJA_quarter4 lon latx depth4 temp4 u4 ssh4 taux4... 
%                                 dudt4 ududx4 vdudy4 wdudz4 zpgf4 corf4 frich4 fricv4
%                             %
